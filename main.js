...
const [is_key_down, get_key] = (() => {
    ...
    return [
        (id) => state.hasOwnProperty(keymap.keycode(id)) && state[keymap.keycode(id)] || false,
        () => {
            const id = key;
            key = undefined;
...
function flip_pixel(x, y) {
    ...
    back_ctx.fillStyle = on ? "#000000" : "#ffffff";
...
function load_font(font) {
    const font_sprites = new Uint8Array(memory_buffer, font_sprites_ptr, font.length);
